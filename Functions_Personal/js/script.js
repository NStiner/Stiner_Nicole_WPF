...
if(prompt2 >= 4 && prompt2 <= 8) {
    if (caloriesNeeded < caloriesNeededPerDay) {
    ...
    if (prompt2 >= 19 && prompt2 <= 30) {
        if (caloriesNeeded < 2200) {
            console.log("You still need to consume " + caloriesNeeded + " calories in order to reach your daily needed amount!");
        } else if (prompt2 >= 19 && prompt2 <= 30 && caloriesNeeded >= 2200) {
            console.log("You have consumed the correct amount of calories you need each day! Good Job!");
        } else {
            console.log("You have consumed the correct amount of calories you need each day! Good Job!");
        }
    ...
    if (prompt2 >= 31 && prompt2 <= 50) {
        if (caloriesNeeded < 2200) {
            console.log("You still need to consume " + caloriesNeeded + " calories in order to reach your daily needed amount!");
        } else if (prompt2 >= 31 && prompt2 <= 50 && caloriesNeeded >= 2200) {
            console.log("You have consumed the correct amount of calories you need each day! Good Job!");
        } else {
            console.log("You have consumed the correct amount of calories you need each day! Good Job!");
        }
