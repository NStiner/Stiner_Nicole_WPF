...
/*
//Check the Login
var correctUserName = "NStiner123";
var correctPassword = "love789";

var userNameEntered = prompt("Please enter your username.");

if(userNameEntered >= "NStiner123") {
        var passwordEntered = prompt("Please type in your password.");
